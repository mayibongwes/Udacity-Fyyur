...
def show_venue(venue_id):
  ...
  if venue is not None:
    data = {
      "id": venue.id,
      "name":venue.name,
      "genres": venue.genres, # ["Jazz", "Reggae", "Swing", "Classical", "Folk"], # Mayi add enum for venue genres
...
def create_venue_submission():
  ...
  if not error:
    ...
    flash(u'An error occurred. Venue ' + request.form['name'] + ' could not be listed!','error')
  return render_template('pages/home.html')
...
def delete_venue(venue_id):
  ...
  if not error:
    flash('Venue ' + request.form['name'] + ' has successfully deleted!')
  else:
    flash(u'An error occurred. Venue ' + request.form['name'] + ' could not be deleted. Please delete any shows related to venue first!','error')
  return render_template('pages/home.html')
